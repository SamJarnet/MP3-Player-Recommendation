...
class LoginManager:
    ...
    def create_login_table(self):
        if self.login_created == False:
            ...
            self.frame1 = customtkinter.CTkFrame(self.mp3_player.master, bg_color="lightgrey",fg_color="darkgrey", 
                                                    width=720, height=480, border_width=5, border_color="black")
    ...
    def login(self):
        ...
        self.frame1.destroy()
        self.frame2 = customtkinter.CTkFrame(self.mp3_player.master, bg_color="lightgrey",fg_color="darkgrey", 
                                             width=720, height=480, border_width=5, border_color="black")
